...
async function render() {
  ...
  content.innerHTML = `
    ...
    <div class="caveat">Prep aid only, not a checklist to rely on alone. Verify against the source record before prepping the tray. No alert &ne; nothing due. A patient not listed below may still have something due. Bloods and checks are drug monitoring. The QOF section is the contract indicators.</div>
    ...
    ${sectionHtml('QOF indicators', model.reviews, showClinician)}
    <div class="footer">
