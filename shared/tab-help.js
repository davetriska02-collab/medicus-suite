...
export const TAB_HELP = {
  ...
  board: {
    ...
    firstStep:
      'Pick a look, add or rename a board, set the words and when the room looks busy, then open it on the computer already plugged into the TV and press Fullscreen (or F).',
  },
  'rota-app': {
    title: 'Rota manager',
