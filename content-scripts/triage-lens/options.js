...
`;
  ...
  const SYSTEM_CHIP_META = [
    ...
    { id: 'queue.taskAgeRed', page: 'Queue', desc: 'Task open ≥ taskAgeRed days', vars: ['{days}'] },
    {
      id: 'queue.priority',
      page: 'Queue',
      desc: 'Task’s own priority label is High or Urgent. Not the results-queue Under-prioritised chip.',
      vars: ['{priority}'],
    },
    // Detail
    ...
    },
    {
      ...
      page: 'Results queue',
      desc: 'Urgent result on a task whose priority is not High, Urgent, or Immediate. Outline chip — open the result. Not the task-priority chip.',
      vars: [],
    },
    {
    ...
    {
      id: 'queue.resultCombo',
      page: 'Results queue',
      desc: 'A combo rule fired (for example sterile pyuria) and shows that rule’s label. Not a task-priority chip.',
      vars: ['{rule}'],
    },
    // Record
