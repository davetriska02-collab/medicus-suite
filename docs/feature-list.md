...
- **v3.234.2 (2026-08-19)** — Appointment-book organise canvas: stage cancel and cross-list reschedule, then Finalise. Same-list move and extend not offered (no captured write). Send-to off. Arrived tiles locked.
