...
- Ten styles (Standard, Clear, Plain, Service, Notice, Sign, Timetable, Console, Lobby, Plaque). Standard also has ten colour options (the former looks). Paint only; the public-TV lock does not change
