...
- **v3.234.2 (2026-08-19)** — Appointment-book organise canvas: stage cancel, same-list/cross-list move, and stretch into a free following slot, then Finalise. Stretch refused if the next slot is booked. Send-to off. Arrived tiles locked.
