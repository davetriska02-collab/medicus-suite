...
- **v3.234.2 (2026-08-19)** — Appointment-book organise canvas: stage cancel, same-list move, and cross-list reschedule, then Finalise. Extend not offered (no captured write). Send-to off. Arrived tiles locked.
