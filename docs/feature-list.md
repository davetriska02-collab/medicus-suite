...
- **v3.236.4 (2026-08-20)** — Allergy convert: “Allergy to X” / “X allergy” codes seed the reaction search with “allergic reaction” so the clinician can convert to a dm+d substance **plus** a reaction code. Search seed only — nothing is pre-selected; a reaction stays optional. Adverse-reaction wording is unchanged.
